...
const buttonVariants = cva(
  "font-mourich font-bold text-base rounded-full transition-all duration-200 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-toby-frosted-pearl hover:bg-toby-frosted-pearl/60 focus:ring-2 focus:ring-toby-forest-ash active:bg-toby-frosted-pearl/20 pressed:text-toby-frosted-pearl disabled:bg-gray-300 disabled:cursor-not-allowed",
        outline:
        ...
        ghost:
          "hover:bg-toby-forest-ash/10 hover:text-toby-forest-ash focus:ring-2 focus:ring-toby-forest-ash active:bg-toby-forest-ash/15 disabled:bg-gray-300 disabled:cursor-not-allowed text-center",
      },
      size: {
